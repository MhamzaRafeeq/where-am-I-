...
import 'schema/address_report_record.dart';
...
export 'schema/address_report_record.dart';
...
/// Functions to query AddressReportRecords (as a Stream and as a Future).
Future<int> queryAddressReportRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AddressReportRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AddressReportRecord>> queryAddressReportRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AddressReportRecord.collection,
      AddressReportRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AddressReportRecord>> queryAddressReportRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
